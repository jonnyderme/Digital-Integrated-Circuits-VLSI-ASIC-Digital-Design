...
# Generated on: Fri Feb 21 00:20:02 EET 2025 (Thu Feb 20 22:20:02 UTC 2025)
...
set_verification_information rtl_mapv_db
...
read_implementation_information fv/picorv32 -revised mapv
...
add_search_path /home/d/deirmentz/VLSI_ASIC/Risc-vVerilog/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/d/deirmentz/VLSI_ASIC/Risc-vVerilog/picorv32.v
...
set_system_mode lec
write_compared_points noneq.compared_points.picorv32.rtl.mapv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.picorv32.rtl.mapv.rpt
}
report_test_vector -noneq > noneq.test_vector.picorv32.rtl.mapv.rpt
